...
add_action('acf/include_fields', function() {
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            ['key' => 'yv_h_tab_tech', 'label' => 'Bandeau technos', 'type' => 'tab'],
            ['key' => 'yv_h_msg_tech', 'type' => 'message', 'message' => '💡 <strong>Section optionnelle</strong> — Si aucune techno n\'est ajoutée, le bandeau ne s\'affiche pas.', 'new_lines' => ''],
            ['key' => 'yv_tech', 'label' => 'Technologies', 'name' => 'tech_logos', 'type' => 'repeater', 'layout' => 'table', 'button_label' => 'Ajouter une techno', 'sub_fields' => [
                ['key' => 'yv_tech_ico', 'label' => 'Icône FA', 'name' => 'icon', 'type' => 'text', 'instructions' => 'Ex: fa-brands fa-wordpress'],
                ['key' => 'yv_tech_lbl', 'label' => 'Libellé', 'name' => 'label', 'type' => 'text', 'instructions' => 'Ex: WordPress'],
            ]],
            ['key' => 'yv_h_tab_marquee', 'label' => 'Bandeau défilant', 'type' => 'tab'],
            ['key' => 'yv_h_msg_marquee', 'type' => 'message', 'message' => '💡 <strong>Section optionnelle</strong> — Si aucun mot n\'est ajouté, le bandeau ne s\'affiche pas.', 'new_lines' => ''],
            ['key' => 'yv_marquee', 'label' => 'Mots défilants', 'name' => 'marquee_items', 'type' => 'repeater', 'layout' => 'table', 'button_label' => 'Ajouter un mot', 'sub_fields' => [
                ['key' => 'yv_marquee_txt', 'label' => 'Texte', 'name' => 'text', 'type' => 'text'],
            ]],
            ['key' => 'yv_h_tab_process', 'label' => 'Méthodologie', 'type' => 'tab'],
            ['key' => 'yv_h_msg_process', 'type' => 'message', 'message' => '💡 <strong>Section optionnelle</strong> — Si aucune étape n\'est ajoutée, la section ne s\'affiche pas.', 'new_lines' => ''],
            ['key' => 'yv_proc_title', 'label' => 'Titre', 'name' => 'process_title', 'type' => 'text', 'instructions' => 'Ex: "Notre méthodologie"'],
            ['key' => 'yv_proc_sub', 'label' => 'Sous-titre', 'name' => 'process_subtitle', 'type' => 'text'],
            ['key' => 'yv_proc', 'label' => 'Étapes', 'name' => 'process_steps', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Ajouter une étape', 'sub_fields' => [
                ['key' => 'yv_proc_ico', 'label' => 'Icône FA', 'name' => 'icon', 'type' => 'text', 'instructions' => 'Ex: fa-solid fa-headset'],
                ['key' => 'yv_proc_t', 'label' => 'Titre', 'name' => 'title', 'type' => 'text'],
                ['key' => 'yv_proc_txt', 'label' => 'Description', 'name' => 'text', 'type' => 'textarea', 'rows' => 2],
            ]],
