    ...
    <nav class="nav-container" aria-label="Navigation principale">
        ...
        <?php if (class_exists('\\Youvanna\\Shop\\Plugin')): ?>
            <div class="nav-actions">
                ...
                <?php endif; ?>
                <a href="<?php echo esc_url(home_url('/coups-de-coeur/')); ?>" class="nav-wishlist" aria-label="<?php esc_attr_e('Mes coups de coeur', 'youvanna-starter'); ?>" title="<?php esc_attr_e('Mes coups de coeur', 'youvanna-starter'); ?>">
                    ...
                    <span class="nav-wishlist__count is-empty" data-yv-wishlist-count>0</span>
                </a>
